  ...
  return (
    <DrawerPortal>
      ...
      <DrawerPrimitive.Content
        ...
        {...props}
      >
        <div className="mx-auto mt-4 hidden h-1.5 w-12 shrink-0 rounded-full bg-border group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  );
...
function DrawerHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('flex flex-col gap-1 p-4 text-center md:text-right', className)}
      {...props}
    />
  );
}
